...
public class oyunicisatinalma2 : MonoBehaviour, IStoreListener
{
    ...
    public static string reklam = "reklam";
    ...
    public void InitializePurchasing()
    {
        ...
        */
        ...
        // sağlıyoruz.
        builder.AddProduct(reklam, ProductType.NonConsumable);
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, reklam, StringComparison.Ordinal))
        {
            PlayerPrefs.SetInt("devamEtButton", 1);
            PlayerPrefs.SetInt("reklamSatinAlma", 1);
            PlayerPrefs.SetInt("mekik5", 1);
            PlayerPrefs.Save();
        }
