...
public class OdulluReklam : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    private void RewardPlayer()
    {
        ...
        PlayerPrefs.SetInt("reklamArabaSayac", PlayerPrefs.GetInt("reklamArabaSayac") + 1);
