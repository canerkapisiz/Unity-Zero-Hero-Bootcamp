...
public class OdulluReklam3 : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    void Start()
    {
        stationManager = FindAnyObjectByType<StationManager>();
    ...
    private void RewardPlayer()
    {
        ...
        stationManager.reklamIzleParaKazan.SetActive(false);
        stationManager.almakIsterMisinPanel.SetActive(false);
        stationManager.ParaKazanmaPanelleriİleİlgili();
        PlayerPrefs.SetInt("anaPara", PlayerPrefs.GetInt("anaPara") + 2500);
